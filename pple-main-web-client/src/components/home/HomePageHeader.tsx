...
color:white;
  background: linear-gradient(104.83deg,rgba(255, 255, 255, 0.3) -5.98%,rgba(255, 255, 255, 0.1) 107.85%);
  box-shadow: inset 3px 3px 2px rgba(255, 255, 255, 0.1),inset -2px -2px 2px rgba(167, 0, 0, 0.1);
